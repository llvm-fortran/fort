...
static void CheckPositiveOrZero(DiagnosticsEngine &Diags,
...
StmtResult Sema::ActOnFORMAT(ASTContext &C, SourceLocation Loc,
  ...
  auto Result =
      FormatStmt::Create(C, Loc, ItemList, UnlimitedItemList, StmtLabel);
  if (StmtLabel)
    DeclareStatementLabel(StmtLabel, Result);
  return Result;
}

FormatItemResult Sema::ActOnFORMATIntegerDataEditDesc(
...
FormatItemResult Sema::ActOnFORMATRealDataEditDesc(
    ASTContext &C, SourceLocation Loc, tok::TokenKind Kind,
    IntegerConstantExpr *RepeatCount, IntegerConstantExpr *W,
...
FormatItemResult Sema::ActOnFORMATLogicalDataEditDesc(
    ASTContext &C, SourceLocation Loc, tok::TokenKind Kind,
    IntegerConstantExpr *RepeatCount, IntegerConstantExpr *W) {
  CheckPositive(Diags, RepeatCount);
  CheckPositive(Diags, W);
...
FormatItemResult Sema::ActOnFORMATCharacterDataEditDesc(
    ASTContext &C, SourceLocation Loc, tok::TokenKind Kind,
    IntegerConstantExpr *RepeatCount, IntegerConstantExpr *W) {
  CheckPositive(Diags, RepeatCount);
  CheckPositive(Diags, W);
...
FormatItemResult Sema::ActOnFORMATPositionEditDesc(ASTContext &C,
                                                   SourceLocation Loc,
                                                   tok::TokenKind Kind,
...
FormatItemResult Sema::ActOnFORMATControlEditDesc(ASTContext &C,
                                                  SourceLocation Loc,
                                                  tok::TokenKind Kind) {
  return FormatItemResult(true);
}

FormatItemResult Sema::ActOnFORMATCharacterStringDesc(ASTContext &C,
                                                      SourceLocation Loc,
                                                      ExprResult E) {
...
FormatItemResult
Sema::ActOnFORMATFormatItemList(ASTContext &C, SourceLocation Loc,
