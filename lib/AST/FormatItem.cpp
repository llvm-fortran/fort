...
IntegerDataEditDesc::IntegerDataEditDesc(SourceLocation Loc,
...
IntegerDataEditDesc *
IntegerDataEditDesc::Create(ASTContext &C, SourceLocation Loc,
                            tok::TokenKind Descriptor,
                            IntegerConstantExpr *RepeatCount,
                            IntegerConstantExpr *W, IntegerConstantExpr *M) {
  return new (C) IntegerDataEditDesc(Loc, Descriptor, RepeatCount, W, M);
}

RealDataEditDesc::RealDataEditDesc(SourceLocation Loc,
                                   tok::TokenKind Descriptor,
                                   IntegerConstantExpr *RepeatCount,
                                   IntegerConstantExpr *w,
...
LogicalDataEditDesc *LogicalDataEditDesc::Create(
    ASTContext &C, SourceLocation Loc, tok::TokenKind Descriptor,
    IntegerConstantExpr *RepeatCount, IntegerConstantExpr *W) {
  return new (C) LogicalDataEditDesc(Loc, Descriptor, RepeatCount, W);
}

CharacterDataEditDesc::CharacterDataEditDesc(SourceLocation Loc,
                                             tok::TokenKind Descriptor,
                                             IntegerConstantExpr *RepeatCount,
                                             IntegerConstantExpr *w)
    : DataEditDesc(Loc, Descriptor, RepeatCount, w) {}

CharacterDataEditDesc *CharacterDataEditDesc::Create(
    ASTContext &C, SourceLocation Loc, tok::TokenKind Descriptor,
    IntegerConstantExpr *RepeatCount, IntegerConstantExpr *W) {
  return new (C) CharacterDataEditDesc(Loc, Descriptor, RepeatCount, W);
}

PositionEditDesc::PositionEditDesc(tok::TokenKind Descriptor,
                                   SourceLocation Loc, IntegerConstantExpr *N)
...
CharacterStringEditDesc *
CharacterStringEditDesc::Create(ASTContext &C, CharacterConstantExpr *Str) {
...
FormatItemList *FormatItemList::Create(ASTContext &C, SourceLocation Loc,
                                       IntegerConstantExpr *RepeatCount,
                                       ArrayRef<FormatItem *> Items) {
...
void CharacterStringEditDesc::print(llvm::raw_ostream &O) { Str->dump(O); }
