...
ExternalStarUnitSpec *ExternalStarUnitSpec::Create(ASTContext &C,
                                                   SourceLocation Loc,
                                                   bool IsLabeled) {
...
ExternalIntegerUnitSpec *ExternalIntegerUnitSpec::Create(ASTContext &C,
                                                         SourceLocation Loc,
                                                         Expr *Value,
                                                         bool IsLabeled) {
...
InternalUnitSpec::InternalUnitSpec(SourceLocation Loc, Expr *Value,
                                   bool IsLabeled)
