...
public:
  ...
  StringRef getOriginalSourceFileName() { return OriginalSourceFile; }
...
public:
  ...
  static ASTUnit *LoadFromCompilerInvocationAction(
      CompilerInvocation *CI, llvm::IntrusiveRefCntPtr<DiagnosticsEngine> Diags,
  ...
  static ASTUnit *
  LoadFromCompilerInvocation(CompilerInvocation *CI,
                             llvm::IntrusiveRefCntPtr<DiagnosticsEngine> Diags);
};
