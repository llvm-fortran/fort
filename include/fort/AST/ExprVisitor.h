...
#define BINOP_FALLBACK(NAME)                                                   \
  ...
  BINOP_FALLBACK(Eqv)
  BINOP_FALLBACK(Neqv)
  BINOP_FALLBACK(Or) BINOP_FALLBACK(And) BINOP_FALLBACK(EQ) BINOP_FALLBACK(NE)
      BINOP_FALLBACK(LT) BINOP_FALLBACK(LE) BINOP_FALLBACK(GT)
          BINOP_FALLBACK(GE) BINOP_FALLBACK(Concat) BINOP_FALLBACK(Add)
              BINOP_FALLBACK(Sub) BINOP_FALLBACK(Mul) BINOP_FALLBACK(Div)
                  BINOP_FALLBACK(Pow)
